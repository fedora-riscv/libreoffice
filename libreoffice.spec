...
# fails HybridPdfTest::testHybridWithAttachedFileAndPass
sed -i -e /CppunitTest_sw_pdf_test/d sw/Module_sw.mk

# fails sc_apitest::ScSolverSettingsObj::testXSolverSettings
...
%define archoptions --disable-nan-tests
%endif
...
%configure \
 --with-vendor="The Fedora Project" \
 %{?with_lang} \
...
%dir %{baseinstdir}/share/themes
%{baseinstdir}/share/themes/*.theme
