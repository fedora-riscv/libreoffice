...
Patch69: 0001-rhbz-966141-adapt-to-ICU-patch-10107.patch
...
%if 0%{?rhel} && 0%{?rhel} >= 7 || %{defined fedora} && 0%{?fedora} >= 18
...
%patch69 -p1 -b .rhbz-966141-adapt-to-ICU-patch-10107.patch
...
* Mon Sep 10 2012 Caolán McNamara <caolanm@redhat.com> - 1:3.5.6.2-3
...
* Mon Jun 18 2012 Caolán McNamara <caolanm@redhat.com> - 3.5.4.2-4
