...
Source11:       %{external_url}/mdds_0.12.1.tar.bz2
Source12:       %{external_url}/5821b806a98e6c38370970e682ce76e8-libcmis-0.5.0.tar.gz
Source13:       %{external_url}/libwps-0.4.0.tar.bz2
Source14:       %{external_url}/libpagemaker-0.0.2.tar.bz2
%global bundling_options %{?bundling_options} --without-system-ucpp --without-system-mdds --without-system-libcmis --without-system-libwps --without-system-libpagemaker
%endif
...
- tdf#86575 for OOXML write plain #REF! if deleted parts, ODFF [#REF!]
...
* Wed Apr 27 2016 David Tardon <dtardon@redhat.com> - 1:5.0.6.2-1
- update to 5.0.6 rc2
...
* Thu Feb 04 2016 Caolán McNamara <caolanm@redhat.com> - 1:5.0.5.1-5
- avoid crash with color listbox in sidebar
...
- Resolves: tdf#93317 gtk3 Modified Document Dialog from alt+f4 doesn't get focus
- Resolves: tdf#95682 add insert symbol button to spell checking dialog
